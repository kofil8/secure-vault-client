...
export default function LoginForm() {
  ...
  return (
    ...
    >
      <Card className='w-full max-w-md border border-black/10 bg-white shadow-lg rounded-lg'>
          ...
          <CardContent className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                className='bg-white border-2 border-gray-300 text-gray-700 placeholder:text-gray-400 rounded-lg p-3 focus:ring-2 focus:ring-teal-500 transition-all duration-300'
                required
                disabled={isPending}
              />
            </div>
